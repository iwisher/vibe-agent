...
from vibe.tools.security.human_approval import ApprovalChoice, ApprovalMode, HumanApprover
...
def test_smart_approval_flow(clean_vibe_dir, tmp_path):
    # Setup
    with (
        patch("vibe.tools.security.approval_store.DEFAULT_STORE_PATH", clean_vibe_dir),
